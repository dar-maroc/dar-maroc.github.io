...
| `utils/store.js` | Couche données : localStorage + Supabase (annonces, services, catégories, témoignages, FAQ, showcase, partenaires) |
...
| `js/services.js`, `js/testimonials.js`, `js/showcase.js`, `js/partners.js` | Rendu services, témoignages, démonstration et partenaires |
...
- `js/main.js`, `js/properties.js`, `js/services.js`, `js/testimonials.js`,
  `js/showcase.js`, `js/partners.js`
