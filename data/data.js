...
window.DARMAROC_DATA = (function () {
  ...
  return {
    ...
    partners: [
      { id: 'pt1', name: 'Marjane', fr: 'Marjane', ar: 'مرجان', icon: 'fa-basket-shopping', delay: 0 },
      { id: 'pt2', name: 'CTM', fr: 'CTM', ar: 'CTM', icon: 'fa-bus', delay: 1 },
      { id: 'pt3', name: 'Maroc Telecom', fr: 'Maroc Telecom', ar: 'اتصالات المغرب', icon: 'fa-tower-cell', delay: 2 },
      { id: 'pt4', name: 'Atlas Copco', fr: 'Atlas Copco', ar: 'أطلس كوبكو', icon: 'fa-industry', delay: 3 },
      { id: 'pt5', name: 'Ciments du Maroc', fr: 'Ciments du Maroc', ar: 'إسمنت المغرب', icon: 'fa-truck-ramp-box', delay: 4 },
      { id: 'pt6', name: 'Alliance Assurances', fr: 'Alliance Assurances', ar: 'أليانس للتأمين', icon: 'fa-shield-halved', delay: 5 },
      { id: 'pt7', name: 'Attijariwafa Bank', fr: 'Attijariwafa Bank', ar: 'التجاري وفا بنك', icon: 'fa-landmark', delay: 6 },
      { id: 'pt8', name: 'Royal Air Maroc', fr: 'Royal Air Maroc', ar: 'الخطوط الملكية المغربية', icon: 'fa-plane', delay: 7 }
    ],
    ...
    testimonials: [
      ...
      { id: 't4', name: 'Fatima Z.', city: 'Agadir', rating: 4, fr: 'Très satisfaite du service de décoration intérieure de DarMaroc. Le résultat correspond à mes attentes, le délai a juste été un peu plus long que prévu. Je referais appel à eux sans hésiter.', ar: 'راضية جداً عن خدمة الديكور الداخلي لدارالمغرب. النتيجة تطابق توقعاتي، فقط تأخر قليلاً عن الموعد المحدد. سأتعامل معهم مرة أخرى دون تردد.' },
      { id: 't5', name: 'Omar B.', city: 'Tanger', rating: 5, fr: 'J\u2019ai loué mon appartement par l\u2019intermédiaire de DarMaroc : des locataires sérieux trouvés en deux semaines et un contrat clair. Service de gestion locative très fiable.', ar: 'أجّرت شقتي عبر دارالمغرب: عثروا على مستأجرين جادين في أسبوعين بعقد واضح. خدمة إدارة عقارية موثوقة جداً.' },
      { id: 't6', name: 'Nadia R.', city: 'Casablanca', rating: 4, fr: 'Bon service de nettoyage après travaux. La maison était impeccable et l\u2019équipe ponctuelle. Je mets 4 étoiles car le tarif est un peu élevé, mais la qualité est au rendez-vous.', ar: 'خدمة تنظيف جيدة بعد الأشغال. كان المنزل نظيفاً تماماً والفريق دقيق في المواعيد. أربع نجوم لأن السعر مرتفع قليلاً، لكن الجودة في الموعد.' }
    ],
